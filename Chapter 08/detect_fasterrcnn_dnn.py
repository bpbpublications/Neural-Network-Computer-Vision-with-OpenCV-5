...
def  detect_coco80objects_using_opencvdnn(image_path, confidence_threshold):
    ...
    net = cv2.dnn.readNetFromTensorflow("../weights/8/faster_rcnn/faster_rcnn_resnet50_coco_2018_01_28.pb", "../weights/8/faster_rcnn/faster_rcnn_resnet50_coco_2018_01_28.pbtxt")

    # Read the COCO class names
    with open("../weights/8/faster_rcnn/coco.names", 'r') as file:
